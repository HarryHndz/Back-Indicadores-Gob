...
export class InitMigration1771271111783 implements MigrationInterface {
    name = 'InitMigration1771271111783'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rol" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-16T19:45:12.485Z"', CONSTRAINT "PK_c93a22388638fac311781c7f2dd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "guvernment_entity" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "description" character varying(250) NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-16T19:45:12.485Z"', CONSTRAINT "PK_dc276a881676ad301c4567e2bd2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "field" ("id" SERIAL NOT NULL, "key" character varying(100) NOT NULL, "label" character varying(150) NOT NULL, "active" boolean NOT NULL DEFAULT true, "type" character varying(50) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-16T19:45:12.485Z"', "validations" jsonb, "options" jsonb, "order_index" integer, "depends_on_value" character varying, "id_depends_on_field" integer, "id_form" integer, CONSTRAINT "PK_39379bba786d7a75226b358f81e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "form" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-16T19:45:12.485Z"', "id_gubernment" integer, CONSTRAINT "PK_8f72b95aa2f8ba82cf95dc7579e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "topic" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id_government_entity" integer, CONSTRAINT "PK_33aa4ecb4e4f20aa0157ea7ef61" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "topic_config" ("id" SERIAL NOT NULL, "required_override" boolean, "visible" boolean NOT NULL DEFAULT true, "id_topic" integer, "id_field" integer, CONSTRAINT "PK_4c3d232348157d8046f1452bf96" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "form_data" ("id" SERIAL NOT NULL, "data" jsonb NOT NULL, "edit" boolean NOT NULL DEFAULT false, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-16T19:45:12.486Z"', "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id_form" integer, "id_topic" integer, "id_user" integer, CONSTRAINT "PK_e88b5f744d04e74477c7952cf6e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "topic" ADD CONSTRAINT "FK_2791edea848c9ac7a5aa2b0626e" FOREIGN KEY ("id_government_entity") REFERENCES "guvernment_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "topic_config" ADD CONSTRAINT "FK_057fe7c1c1fa470fd068e8f8ce2" FOREIGN KEY ("id_topic") REFERENCES "topic"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "topic_config" ADD CONSTRAINT "FK_ab44119fae4cfb79487eec91e89" FOREIGN KEY ("id_field") REFERENCES "field"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "topic_config" DROP CONSTRAINT "FK_ab44119fae4cfb79487eec91e89"`);
        await queryRunner.query(`ALTER TABLE "topic_config" DROP CONSTRAINT "FK_057fe7c1c1fa470fd068e8f8ce2"`);
        await queryRunner.query(`ALTER TABLE "topic" DROP CONSTRAINT "FK_2791edea848c9ac7a5aa2b0626e"`);
        ...
        await queryRunner.query(`DROP TABLE "topic_config"`);
