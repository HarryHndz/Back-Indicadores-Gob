...
export class InitMigration1771860241742 implements MigrationInterface {
    name = 'InitMigration1771860241742'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rol" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-23T15:24:02.607Z"', CONSTRAINT "PK_c93a22388638fac311781c7f2dd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "guvernment_entity" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "description" character varying(250) NOT NULL, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-23T15:24:02.608Z"', "isHaveSubGubernment" boolean NOT NULL DEFAULT false, "id_parent_gubernment" integer, CONSTRAINT "PK_dc276a881676ad301c4567e2bd2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "field" ("id" SERIAL NOT NULL, "key" character varying(100) NOT NULL, "label" character varying(150) NOT NULL, "placeholder" character varying(250) NOT NULL, "active" boolean NOT NULL DEFAULT true, "type" character varying(50) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-23T15:24:02.609Z"', "validations" jsonb, "options" jsonb, "order_index" integer, "depends_on_value" character varying, "id_depends_on_field" integer, "id_form" integer, "id_topic" integer, CONSTRAINT "PK_39379bba786d7a75226b358f81e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "form" ("id" SERIAL NOT NULL, "name" character varying(150) NOT NULL, "description" character varying(250) NOT NULL, "active" boolean NOT NULL DEFAULT true, "yearFiscal" character varying(50), "update_period" character varying(50), "createdAt" TIMESTAMP NOT NULL DEFAULT '"2026-02-23T15:24:02.609Z"', "id_gubernment" integer, CONSTRAINT "PK_8f72b95aa2f8ba82cf95dc7579e" PRIMARY KEY ("id"))`);
